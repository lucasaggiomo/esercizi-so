...
int main() {
    ...
    // ottiene la coda per l'invio dei messaggi app al livello trasporto del client
    ...
    // ottiene la coda per la ricezione del messaggio di ACK finale dal livello trasporto del client
